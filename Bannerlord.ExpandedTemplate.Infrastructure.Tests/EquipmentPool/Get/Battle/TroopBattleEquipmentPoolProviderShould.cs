...
namespace Bannerlord.ExpandedTemplate.Infrastructure.Tests.EquipmentPool.Get.Battle;

public class TroopBattleEquipmentPoolProviderShould
{
    ...
    private TroopBattleEquipmentPoolProvider _troopEquipmentPoolProvider;
    ...
    public void Setup()
    {
        ...
        _loggerFactory.Setup(factory => factory.CreateLogger<TroopBattleEquipmentPoolProvider>())
            .Returns(new Mock<ILogger>().Object);

        _troopEquipmentPoolProvider =
            new TroopBattleEquipmentPoolProvider(_loggerFactory.Object, _equipmentPoolsProvider.Object);
    }
    ...
    {
        var actualEquipmentPools = _troopEquipmentPoolProvider.GetBattleTroopEquipmentPools("");
    ...
    {
        var actualEquipmentPools = _troopEquipmentPoolProvider.GetBattleTroopEquipmentPools(null!);
    ...
    public void ReturnNoEquipmentPoolsIfTroopIdDoesNotExist()
    {
        ...
        var actualEquipmentPools = _troopEquipmentPoolProvider.GetBattleTroopEquipmentPools(FirstTroopId);
